      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TOOL_USE_CASES.map((item, idx) => {
            ...
            return (
              <div key={idx} className="bg-white dark:bg-zinc-950 rounded-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden hover:shadow-lg hover:border-blue-500/30 transition-all duration-300">
                  ...
                  <ul className="space-y-3">
                    {item.uses.map((use, uIdx) => (
                      <li key={uIdx} className="flex items-start">
                        <Check className="h-5 w-5 text-blue-600 dark:text-blue-500 mr-2 shrink-0" />
