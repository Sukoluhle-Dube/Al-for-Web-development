      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {PREREQUISITES.map((item, idx) => {
            ...
            return (
              <div key={idx} className="flex items-center bg-white dark:bg-zinc-800 px-6 py-4 rounded-full shadow-md dark:shadow-lg border border-zinc-200 dark:border-zinc-700 hover:border-yellow-400 dark:hover:border-yellow-500 transition-colors">
                <Icon className="h-5 w-5 text-yellow-600 dark:text-yellow-400 mr-3" />
